...
/*   Updated: 2024/06/11 16:31:43 by obrittne         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	get_start_pos(t_data *data, t_ray *ray)
{
	...
	ray->map_cord_x = player_x + lround((ray->x - data->player->x) * 32.0);
	ray->map_cord_y = player_y + lround((ray->y - data->player->y) * 32.0);
}
